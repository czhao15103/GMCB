% read in the data
ystart = 'n100p5q5_DP2002_3A_XJ2019_1_y';
filetype = '.csv';
y = cell([1 2000]);
for i = 1:2000
    istr = num2str(i);
...
xstart = 'n100p5q5_DP2002_3A_XJ2019_1_x.csv';
x_single = readmatrix(xstart);

% burnin and number of iterations for sampler
% based on multivariate ESS, use 3e4 iterations
burnin = 0; nmc = 3e4;
q = size(y{1}, 2);
p = size(x_single, 2);
...
save('n100p5q5_DP2002_3A_XJ2019_1', 'beta_mean', 'omega_mean', 'beta_quad', 'omega_stein');
