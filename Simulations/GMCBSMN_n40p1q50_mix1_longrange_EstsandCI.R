...
#### GMCB-SMN n = 40, p = 1, q = 50, estimates and credible intervals ####
...
filestart <- "SMN_n40p1q50_mix1_longrange_rep"

# for saving files
estname <- "SMN_n40p1q50_mix1_longrange_ests"
...
for (i in 1:reps) {
	...
	credsave <- paste("SMN_n40p1q50_mix1_longrange_95CredInt", i, ".rds", sep = "")
...
loss_save <- "SMN_n40p1q50_mix1_longrange_losses.rds"
