...
filestart <- "n40p1q50_HSGHS_rep"

# for saving files
estname <- "HSGHS_n40p1q50_ests"
...
for (i in 1:reps) {
	...
	b.vec <- t(sapply(1:dim(out$beta.save)[3], function(x) out$beta.save[,,x]))
	...
	credsave <- paste("HSGHS_n40p1q50_95CredInt", i, ".rds", sep = "")
...
loss_save <- "HSGHS_n40p1q50_losses.rds"
