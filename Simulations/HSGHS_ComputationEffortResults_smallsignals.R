...
# file location
fileprefix <- "n100p5q5_smallsignalsCS_ComputationComparison"
...
set.seed(212)
ests <- foreach(i = 1:2000, .packages = c("R.matlab", "mcmcse")) %dorng% {
...
saveRDS(ests, file = "ComputationEffortResults_smallsignals.rds")
