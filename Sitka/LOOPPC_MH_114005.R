...
# Note that this code assumes a folder named LOO_GMCBMH_Sitka1988_114005 exists in the 
...
set.seed(330)
logpostpred_mh_114005 <- foreach(i = 1:n, .combine = c, .packages = c("GMCB")) %dorng% {
  # fit the model
  outn <- gmcb(y.stand[-i,], x[-i,], initial.values = forscaling$final.values,
              ...
              algorithm = "MH")
  saveRDS(outn, file = paste("LOO_GMCBMH_Sitka1988_114005/LOO_GMCBMH_Sitka1988_114005_", i, ".rds", sep = ""))
...
saveRDS(logpostpred_mh_114005, file = "LOOPPC_MH_114005.rds")
